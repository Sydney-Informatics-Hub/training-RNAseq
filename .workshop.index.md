...
organiser: ["FIXME]     # optional, same formatting as helpers. If you don't want the heading to appear, delete the brackets "[]" too!
...
<p id="requirements">
  ...
  SIH's
  {% endif %}
  <a href="{{ page.root }}{% link CODE_OF_CONDUCT.md %}">Code of Conduct</a>.
</p>
